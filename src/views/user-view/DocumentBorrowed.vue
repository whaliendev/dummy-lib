...
import { documentBorrowed } from '@/mock/user-view/document'
const pageSize = ref(10)
const borrowedNum = ref(17)
const documentList = ref<Array<DocumentMetaModel>>(documentBorrowed)
...
<template>
  <div classs="document-borrrowed document-borrowed-container">
    <div class="borrow-list borrow-list-container">
      <DocumentItem
